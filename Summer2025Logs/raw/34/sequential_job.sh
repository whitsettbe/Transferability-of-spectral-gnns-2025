...
/home/bsw38/.conda/envs/benchmark_gnn_2/bin/python -u main_molecules_graph_regression.py --dataset ZINC --seed 41 --config 'configs/molecules_graph_regression_ChebAugmented_ZINC_no_rsd.json'
