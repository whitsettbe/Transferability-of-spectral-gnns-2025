...
/home/bsw38/.conda/envs/benchmark_gnn_2/bin/python -u main_dgl.py --dataset ogbg-molpcba --gnn Spec_filters --filename ../SpecFiltTestMolPCBA_15 --dropout 0.25 --num_layer 5 --hidden_dim 25 --no_residual --filter_grouping features --l1_reg 1.0