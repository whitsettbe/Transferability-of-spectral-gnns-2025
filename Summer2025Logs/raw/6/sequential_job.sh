...
/home/bsw38/.conda/envs/benchmark_gnn_2/bin/python -u main_dgl.py --dataset ogbg-molhiv --gnn Spec_filters --filename ../SpecFiltTestMolHIV --dropout 0.75 --num_layer 1 --hidden_dim 25 --no_residual --filter_grouping eigen --no_biases